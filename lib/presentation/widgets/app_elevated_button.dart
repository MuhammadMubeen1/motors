...
import 'package:motors_app/core/styles/dimensions.dart';
...
class AppButtonSizeConfig {
  ...
  static const regular = AppButtonSizeConfig(height: 49, radius: 30.0);
  static const small = AppButtonSizeConfig(height: 45, radius: 30);
}
