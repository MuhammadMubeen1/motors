...
class BMWListScreen extends StatefulWidget {
  final String makeName;

  const BMWListScreen({Key? key, required this.makeName}) : super(key: key);

  @override
  _BMWListScreenState createState() => _BMWListScreenState();
}

class _BMWListScreenState extends State<BMWListScreen> {
  ...
  Future<void> fetchBMWListings() async {
    try {
      final response = await http.get(Uri.parse(
          'https://wheelers.pk/wp-json/stm-mra/v1/filtered-listings?make%5B0%5D=${widget.makeName}'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Browse ${widget.makeName}', style: TextStyle(color: Colors.black)),
        leading: IconButton(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  else if (car['discountPrice'] != null && car['discountPrice'] != '')
                    ColoredBox(
                      color: ColorApp.mainColor,
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              car['price'] != null && car['price'] != '' ? car['price'] : 'No price',
                              style: const TextStyle(
                                color: Colors.black,
                          ...
                          child: Row(
                            children: [
                              Padding(
                                ...
                                child: Icon(
                                  dictionaryIcons[car['grid']?['infoIcon']] ?? Icons.info,
                                  size: 15,
                                  color: ColorApp.mainColor,
                                ),
                              ),
